...
export default {
  methods: {
    ...
    c_year_page(currentPage){
      const _this = this
      axios.get('http://localhost:8181/bank/findCheckYear/'+currentPage+'/'+_this.c_year_size+'').then(function (resp){
    ...
    c_season_page(currentPage){
      const _this = this
      axios.get('http://localhost:8181/bank/findCheckSeason/'+currentPage+'/'+_this.c_season_size+'').then(function (resp){
    ...
    c_month_page(currentPage){
      const _this = this
      axios.get('http://localhost:8181/bank/findCheckMonth/'+currentPage+'/'+_this.c_month_size+'').then(function (resp){
  ...
  created() {
    ...
    axios.get('http://localhost:8181/bank/findCheckYear/1/'+_this.c_year_size+'').then(function (resp){

      _this.checkTableYear = resp.data.statisticsByYears
      _this.c_year_total = resp.data.totalElements

    })
    axios.get('http://localhost:8181/bank/findCheckSeason/1/'+_this.c_season_size+'').then(function (resp){

      _this.checkTableSeason = resp.data.statisticsBySeasons
      _this.c_season_total = resp.data.totalElements

    })
    axios.get('http://localhost:8181/bank/findCheckMonth/1/'+_this.c_month_size+'').then(function (resp){
